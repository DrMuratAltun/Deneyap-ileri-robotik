...
//Aşağıdaki teta değerleri 0-3000 arasında kalibre edilmiştir. 3000 değeri 180 derecey4e  karşılık elmektedir
int teta1min=0;
int teta1max=3000;
int teta2min=0;
int teta2max=3000;
...
//Josyticklerin ürettiği analog sinyallerin okunduğu ve motor açı değerlerinin bu
//sinyallere göre değiştirildiği fonksiyon aşağıda verilmiştir.
void ReadAnalog() {
...
//Hafızaya kaydedilen servo motor konumlarının tekrarlatıldığı fonksiyon aşağıda verilmiştir.
void playit()
{
float pos1=prepos1;
float pos2=prepos2;

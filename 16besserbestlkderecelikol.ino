...
/*Buton fonksiyonu oldukça kapsamlıdır. Burada 2 adet buton ile robot hareket modları
tayin edilmektedir. Öğretme modunda iken joystick 1’in butona tek tıklama ile mevcut motor
açılarını hafızaya alma işlemi yapılabilmekte, öğretme modundan tekrarlama moduna veya
tersine yine Joystick 1’in butonuna çift tıklayarak geçilebilmektedir. Bu uygulamada da
motorlara hızlı, normal ve yavaş olmak üzere 3 ayrı seviye tayin edilmiştir. Bu hız seviyeleri
arasındaki geçişler Joystick 2’nin butonuna basılarak gerçekleştirilmektedir. Belirtilen buton
aktivitelerini gerçekleştiren kodlar aşağıda verilmiştir.*/
void Button() {
if (playmode==false){
...
//Mevcut servo motor açılarının hafızaya kaydedildiği fonksiyon aşağıda verilmiştir.
void saveit() {
...
/*Hafızaya kaydedilen servo motor konumlarının tekrarlatıldığı fonksiyon aşağıda
verilmiştir.*/
void playit()
{
float pos1=prepos1;

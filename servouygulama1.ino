#include "deneyap.h" 
//Deneyap kart kütüphanesinin programa eklenmesi
#include <ESP32Servo.h> 
//Servo motor kütüphanesinin programa eklenmesi
#define SERVOPIN D0 
//servo motorun bağlandığı D0 pininin tanımlaması
#define L1_pin D14 
//sağ ışık sensörünün bağlandığı D14 pininin tanımlaması
